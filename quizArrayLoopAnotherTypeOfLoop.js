...
test.forEach(function(element, pos, array){
//    element % 3 === 0 ? array[pos]=array[pos]+100: element;
//});
    if (element % 3 === 0){ //checks if the element is divisible by 3
        array[pos]=array[pos]+100; //if so adds 100 to the value of the element
    }});
console.log(test);

...
*/
// defines the weapon based on the room.
...
//Checks if the suspect was in the room.
...
/* ****************************************** */
// The code below will give the result of the game.
if (solved) {
	console.log(suspect + " did it in the " + room + " with the " + weapon + "!");
} else {
    console.log("Sorry, " + suspect + " was not in the " + room + ".");
}
/* ****************************************** */
